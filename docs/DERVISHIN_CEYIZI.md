...
```python
# Emare CC — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emarecc.view',      # Görüntüleme
    'emarecc.create',    # Oluşturma
    'emarecc.edit',      # Düzenleme
    'emarecc.delete',    # Silme
    'emarecc.manage',    # Tam yönetim
    # Admin
    'emarecc.admin',     # Admin panele erişim
    'emarecc.users',     # Kullanıcı yönetimi
    'emarecc.settings',  # Ayar yönetimi
]
```
...
```python
# emarecc/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emarecc.view', 'emarecc.create',
        'emarecc.edit', 'emarecc.delete',
        'emarecc.manage', 'emarecc.users',
        'emarecc.settings', 'emarecc.admin',
    },
    'operator': {
        'emarecc.view', 'emarecc.create',
        'emarecc.edit',
...
| Proje Admini | admin@emarecc.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emarecc.emare.dev | super_admin | Machine-to-machine |
